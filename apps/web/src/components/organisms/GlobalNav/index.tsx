    ...
    <nav className="bg-fill-strong/95 fixed z-20 mx-auto h-16 w-full px-4 xl:px-0">
      <div className="mx-auto flex h-full max-w-[1200px] items-center justify-between">
        <div className="flex items-center gap-32">
          ...
          <div className="text-text-subtler flex gap-16 text-sm">
            ...
            <Link className="hover:text-text-strong" href={'/content'}>
              예능 눕프핵
            </Link>
            <Link className="hover:text-text-strong" href={'/content'}>
              배치고사
            </Link>
            <Link className="hover:text-text-strong" href={'/game'}>
              게임
            </Link>
          </div>
        </div>
        <button
          onClick={toggleTheme}
          className="hover:text-text-strong text-text-subtler cursor-pointer"
        >
